import { Box, Button, Container, Flex, FormControl, FormLabel, Heading, Input, InputGroup, InputLeftAddon, Stack, Textarea, useColorModeValue, VStack } from '@chakra-ui/react';
                  ...
                  <VStack spacing={5}>
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        ...
                        type='tel'
                        value={phoneNumber}
                        onChange={handlePhoneChange} name="telefone" placeholder="Seu telefone" />
                      </InputGroup>
                  ...
                  <VStack spacing={5}>
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        ...
                        type='text'
                        value={otp}
                        onChange={handleVerifyChange} name="codigo" placeholder="Insira aqui o código recebido" />
                      </InputGroup>
                    </FormControl>
